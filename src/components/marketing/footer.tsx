    ...
    <footer className="bg-gray-800 py-12 text-gray-300">
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="mb-4 text-lg font-bold text-white">BrandConnect</h3>
            <p className="mb-4">
              Conectando marcas e influencers para crear colaboraciones auténticas y efectivas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span>info@brandconnect.com</span>
              </li>
              <li className="flex items-center">
                <svg className="mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p>&copy; {new Date().getFullYear()} BrandConnect. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
