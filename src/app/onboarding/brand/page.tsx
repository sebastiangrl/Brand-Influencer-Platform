...
export default function BrandOnboarding() {
  ...
  const handleComplete = async () => {
    ...
    // Aquí normalmente actualizarías más información de la marca
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      <h1 className="text-3xl font-bold mb-6">Completa tu perfil de marca</h1>
      
      <div className="bg-white p-6 rounded-lg shadow-md">
        <p className="mb-4">
          ¡Bienvenido/a a nuestra plataforma! Completa la información de tu marca
          para comenzar a conectar con influencers.
        </p>
